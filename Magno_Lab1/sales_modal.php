...
<div class="modal fade" id="details<?php echo $row['purchaseid']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content box-design">
            <div class="modal-header">
                <center><h4 class="modal-title" id="myModalLabel" style="font-family: Apple Chancery, cursive;">SALES FULL DETAILS</h4></center>
            </div>
            <div class="modal-body main">
                <div class="container-fluid">
                    <h5 style="text-align: left;">Customer: <b><?php echo $row['customer']; ?></b>
                        <span class="pull-right">
                        <ul>Date Ordered: </ul><?php echo date('M d, Y h:i A', strtotime($row['date_purchase'])) ?>
                        </span>
                    </h5>
